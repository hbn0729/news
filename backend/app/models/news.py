...
class NewsArticle(Base):
    ...
    ai_processed: Mapped[bool] = mapped_column(Boolean, server_default=text("false"), default=False)

    # Status
    is_read: Mapped[bool] = mapped_column(Boolean, server_default=text("false"), default=False)
    is_starred: Mapped[bool] = mapped_column(Boolean, server_default=text("false"), default=False)
    is_filtered: Mapped[bool] = mapped_column(Boolean, server_default=text("false"), default=False)
    ...
    __table_args__ = (
        ...
        Index("idx_news_ai_score", "ai_quality_score", postgresql_where=text("NOT is_filtered")),
